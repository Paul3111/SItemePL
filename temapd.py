...
df.to_csv("fisier_date.csv")
# print(df)
df1 = df.replace(": ", 0)
df1.to_csv("fisier_date.csv")
# print(df.info())
# print(df1)

# clean_description = [y.strip() for y in description[1]]
#
...
df1 = pd.read_csv("fisier_date.csv")
for country in df1:
    if country != "Unnamed: 0":
        print(df1[country].mean())
        # a = list(map(int, country.split(" ")))
        # print(df1[country][7])


# 03.Calculati media pe fiecare tara pe care sa o adaugati ca si ultima coloana in tabelul format mai sus
# 4.Afisati informatiireferitoare la date cu ajutorul functiei describe
